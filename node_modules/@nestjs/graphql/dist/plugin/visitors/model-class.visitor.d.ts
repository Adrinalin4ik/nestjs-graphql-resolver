...
export declare class ModelClassVisitor {
    ...
    createTypePropertyAssignment(node: ts.PropertyDeclaration | ts.PropertySignature, typeChecker: ts.TypeChecker, existingProperties: ts.NodeArray<ts.PropertyAssignment>, hostFilename: string, sourceFile: ts.SourceFile, pluginOptions: PluginOptions): ts.PropertyAssignment;
