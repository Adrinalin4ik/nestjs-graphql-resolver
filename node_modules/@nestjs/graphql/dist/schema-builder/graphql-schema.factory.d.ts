...
export declare class GraphQLSchemaFactory {
    ...
    create(resolvers: Function[], scalarClasses: Function[]): Promise<GraphQLSchema>;
    create(resolvers: Function[], options: BuildSchemaOptions): Promise<GraphQLSchema>;
    create(resolvers: Function[], scalarClasses: Function[], options: BuildSchemaOptions): Promise<GraphQLSchema>;
